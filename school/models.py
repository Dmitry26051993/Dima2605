...
from sqlalchemy import create_engine, Table, Column, String, Float, ForeignKey, Integer
...
class Book(Base):
    ...
    students = relationship('Student', secondary=assotiation_table, backref='books')
