...
# Создать сайт.
# Создать напрямую в базе 3 группы. Описать шаблон и вью для получения и отображения списка всех групп.
...
# На ветке flask_school. Создать шаблон и вью для редактирования группы.
# Добавить кнопку возле каждой записи на главной страницы для редактирования сущности.
# Создать вью для удаления сущности.
# Добавить кнопку возле каждой записи на главной страницы для удаления сущности.
